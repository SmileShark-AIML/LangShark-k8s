          ...
          <Popover key={configId}>
            ...
            <PopoverContent>
              <h2 className="text-md mb-3 font-semibold">
                {isArchived ? "설정 복구" : "설정 보관"}
              </h2>
              <p className="mb-3 text-sm">
                현재 설정{" "}
                {isArchived
                  ? `은 보관되어 있습니다. 주석에 "${name}"을(를) 다시 사용하려면 복원합니다.`
                  : `이 활성화되어 있습니다. 주석에 "${name}"을(를) 더 이상 사용하지 않으려면 보관하십시오. 과거 "${name}" 점수는 계속 표시되며 삭제할 수 있습니다. 언제든지 구성을 복원할 수 있습니다.`}
              </p>
