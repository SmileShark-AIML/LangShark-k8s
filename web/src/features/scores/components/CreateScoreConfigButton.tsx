    ...
    <>
      ...
      >
        ...
        <DialogContent className="max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>새로운 평가지표 생성</DialogTitle>
          </DialogHeader>
          <Form {...form}>
            <form
              className="space-y-6"
              ...
              {isNumericDataType(form.getValues("dataType")) ? (
                <>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>최소 (optional)</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>최대 (optional)</FormLabel>
                        <FormControl>
                          <Input {...field} type="number" />
                        </FormControl>
                        <FormMessage />
            ...
            >
              ...
              <DialogContent>
                ...
                <p className="text-sm">
                점수 구성은 생성된 후 편집하거나 삭제할 수 없습니다. 계속하시겠습니까?
                </p>
